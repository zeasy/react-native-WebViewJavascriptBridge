...
export default class WebViewJavascriptBridge extends React.Component {
    constructor(props) {
        ...
        this.protocolScheme = (props.protocolScheme || 'https').toLowerCase()
...
/* #### private ####*/
    ...
    injectJavascriptFile(){
        var js = WebViewJavascriptBridge_JS(this.protocolScheme,this.bridgeName,this.callbacksName, this.injectBridgeJS)
    ...
    onMessage(e) {
        ...
        if(e.nativeEvent.data) {
            ...
            if(typeof data == 'object' && this.isQueueMessageURL(new URL(data.url))) {
